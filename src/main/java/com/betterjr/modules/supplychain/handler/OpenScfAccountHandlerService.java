...
public class OpenScfAccountHandlerService {
    ...
    public void processNotification(final Object anMessage) {
        ...
        FactorParam param = DictUtils.loadObject("FactorParam", String.valueOf(custRelation.getRelateCustno()),
                FactorParam.class);
    ...
    private SaleAccoRequestInfo createOpenAccountRequestData(CustRelation custRelation) {
        ...
        accountRequest.setCustType(
                relationService.checkCoreCustomer(custRelation.getCustNo(), custRelation.getRelateCustCorp()));
