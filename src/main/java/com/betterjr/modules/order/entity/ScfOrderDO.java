...
public class ScfOrderDO extends BaseVersionEntity {
    ...
    public String toString() {
        return "ScfOrderDO [orderNo=" + this.orderNo + ", btOrderNo=" + this.btOrderNo + ", btNo=" + this.btNo
                + ", custNo=" + this.custNo + ", custName=" + this.custName + ", orderType=" + this.orderType
                + ", regDate=" + this.regDate + ", regTime=" + this.regTime + ", goodsName=" + this.goodsName
                + ", orderDate=" + this.orderDate + ", endDate=" + this.endDate + ", unit=" + this.unit + ", amount="
                + this.amount + ", balance=" + this.balance + ", coreCustNo=" + this.coreCustNo + ", coreCustName="
                + this.coreCustName + ", modiOperId=" + this.modiOperId + ", modiOperName=" + this.modiOperName
                + ", operOrg=" + this.operOrg + ", modiDate=" + this.modiDate + ", modiTime=" + this.modiTime
                + ", settlement=" + this.settlement + ", batchNo=" + this.batchNo + ", resolveFileId="
