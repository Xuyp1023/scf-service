...
public class ScfInvoiceDO extends BaseVersionEntity {
    ...
    public String toString() {
        return "ScfInvoiceDO [invoiceCode=" + this.invoiceCode + ", invoiceNo=" + this.invoiceNo + ", custNo="
                + this.custNo + ", custName=" + this.custName + ", custTaxpayerNo=" + this.custTaxpayerNo
                + ", custPhone=" + this.custPhone + ", custAccount=" + this.custAccount + ", regOperId="
                + this.regOperId + ", regOperName=" + this.regOperName + ", operOrg=" + this.operOrg + ", regDate="
                + this.regDate + ", regTime=" + this.regTime + ", modiOperId=" + this.getModiOperId()
                + ", modiOperName=" + this.modiOperName + ", modiDate=" + this.modiDate + ", modiTime=" + this.modiTime
                + ", corpVocate=" + this.corpVocate + ", invoiceDate=" + this.invoiceDate + ", balance=" + this.balance
                + ", drawer=" + this.drawer + ", batchNo=" + this.batchNo + ", description=" + this.description
                + ", coreCustNo=" + this.coreCustNo + ", coreCustName=" + this.coreCustName + ", coreCustTaxpayerNo="
                + this.coreCustTaxpayerNo + ", coreCustPhone=" + this.coreCustPhone + ", coreCustAccount="
                + this.coreCustAccount + ", getRefNo()=" + this.getRefNo() + ", getVersion()=" + this.getVersion()
                + ", getIsLatest()=" + this.getIsLatest() + ", getBusinStatus()=" + this.getBusinStatus()
                + ", getLockedStatus()=" + this.getLockedStatus() + ", getDocStatus()=" + this.getDocStatus()
                + ", getAuditOperId()=" + this.getAuditOperId() + ", getAuditOperName()=" + this.getAuditOperName()
                + ", getAuditData()=" + this.getAuditData() + ", getAuditTime()=" + this.getAuditTime() + ", getId()="
                + this.getId() + "]";
    }
