...
public class ScfInvoiceDOService extends BaseVersionService<ScfInvoiceDOMapper, ScfInvoiceDO> {
    ...
    public List<ScfInvoiceDO> queryReceivableList(String receivableIds) {
        ...
        if (StringUtils.isNoneBlank(receivableIds)) {
            ...
            Map<String, Object> paramMap = QueryTermBuilder.newInstance().put("invoiceNo", receivableArray)
                    .put("businStatus", VersionConstantCollentions.BUSIN_STATUS_EFFECTIVE).build();
