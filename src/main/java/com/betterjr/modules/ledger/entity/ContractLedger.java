...
public class ContractLedger extends BetterjrBaseEntity {
    ...
    public String toString() {
        return "ContractLedger [id=" + this.getId() + ", agreeName=" + this.agreeName + ", agreeNo=" + this.agreeNo
                + ", supplier=" + this.supplier + ", buyer=" + this.buyer + ", balance=" + this.balance
                + ", deliveryDate=" + this.deliveryDate + ", deliveryAddr=" + this.deliveryAddr + ", checkAccept="
                + this.checkAccept + ", objectionPeriod=" + this.objectionPeriod + ", agreeStartDate="
                + this.agreeStartDate + ", agreeEndDate=" + this.agreeEndDate + ", regDate=" + this.regDate
                + ", regTime=" + this.regTime + ", modiDate=" + this.modiDate + ", modiTime=" + this.modiTime
                + ", businStatus=" + this.getBusinStatus() + ", buyerNo=" + this.buyerNo + ", coreCustNo="
                + this.coreCustNo + ", supplierNo=" + this.supplierNo + ", operId=" + this.operId + ", operName="
                + this.operName + ", operOrg=" + this.operOrg + ", batchNo=" + this.batchNo + ", defaultFlag="
                + this.defaultFlag + ", des=" + this.des + ", signDate=" + this.signDate + ", signAddr=" + this.signAddr
                + ", custNo=" + this.custNo + ", custName=" + this.custName + ", lockedStatus=" + this.getLockedStatus()
                + ", refNo=" + this.getRefNo() + ", version=" + this.getVersion() + ", isLatest=" + this.getIsLatest()
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getDefaultFlag() == null ? other.getDefaultFlag() == null
                        : this.getDefaultFlag().equals(other.getDefaultFlag()))
    ...
    public void checkFinanceStatus() {
        ...
        checkStatus(this.getBusinVersionStatus(), VersionConstantCollentions.BUSIN_STATUS_ANNUL, true,
                "当前单据已经废止,无法进行融资,凭证编号为：" + this.getRefNo());
        checkStatus(this.getBusinVersionStatus(), VersionConstantCollentions.BUSIN_STATUS_EXPIRE, true,
                "当前单据已经过期,无法进行融资,凭证编号为：" + this.getRefNo());
        checkStatus(this.getBusinVersionStatus(), VersionConstantCollentions.BUSIN_STATUS_INEFFECTIVE, true,
                "当前单据还未生效,无法进行融资,凭证编号为：" + this.getRefNo());
        checkStatus(this.getBusinVersionStatus(), VersionConstantCollentions.BUSIN_STATUS_TRANSFER, true,
                "当前单据已经转让,无法进行融资,凭证编号为：" + this.getRefNo());
        checkStatus(this.getBusinVersionStatus(), VersionConstantCollentions.BUSIN_STATUS_USED, true,
