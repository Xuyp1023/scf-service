...
public class ScfAcceptBillDubboService implements IScfAcceptBillService {
    ...
    @Override
    public String webQueryAcceptBill(final Map<String, Object> anMap, final String anIsOnlyNormal, final String anFlag,
            final int anPageNum, final int anPageSize) {

        final Map<String, Object> anQueryConditionMap = (Map<String, Object>) RuleServiceDubboFilterInvoker
                .getInputObj();
        return AjaxObject.newOkWithPage("汇票信息查询成功", scfAcceptBillService.queryAcceptBill(anQueryConditionMap,
    ...
    @Override
    public String webSaveModifyAcceptBill(final Map<String, Object> anMap, final Long anId, final String anFileList,
            final String anOtherFileList) {

        final ScfAcceptBill anAcceptBill = (ScfAcceptBill) RuleServiceDubboFilterInvoker.getInputObj();
        return AjaxObject
                .newOk("汇票信息修改成功",
                        scfAcceptBillService.saveModifyAcceptBill(anAcceptBill, anId, anFileList, anOtherFileList))
                .toJson();
    }

    @Override
    public String webAddAcceptBill(final Map<String, Object> anMap, final String anFileList,
            final String anOtherFileList) {

        final ScfAcceptBill anAcceptBill = (ScfAcceptBill) RuleServiceDubboFilterInvoker.getInputObj();
        return AjaxObject
                .newOk("汇票信息登记成功", scfAcceptBillService.addAcceptBill(anAcceptBill, anFileList, anOtherFileList))
                .toJson();
    }
    ...
    public String webAddAcceptBillDO(Map<String, Object> anMap, String anFileList, boolean anConfirmFlag) {
        ...
        return AjaxObject.newOk("票据登记成功", acceptBillService.addAcceptBill(anAcceptBill, anFileList, anConfirmFlag))
                .toJson();
    ...
    public String webQueryFinancedByFactor(final Map<String, Object> anMap, final Long anFactorNo) {
        final Map<String, Object> anBillConditionMap = (Map<String, Object>) RuleServiceDubboFilterInvoker
                .getInputObj();
        return AjaxObject.newOkWithPage("保理公司查询已融资汇票",
                scfAcceptBillService.queryFinancedByFactor(anBillConditionMap, anFactorNo)).toJson();
    }
    ...
    public String webSaveBillFile(Long anBillId, String anFileTypeName, String anFileMediaId) {
        return AjaxObject.newOk("保存票据附件", scfAcceptBillService.saveBillFile(anBillId, anFileTypeName, anFileMediaId))
                .toJson();
    }
    ...
    public String webSaveModifyAcceptBillDO(Map<String, Object> anMap, String anFileList, boolean anConfirmFlag) {
        ...
        ScfAcceptBillDO anAcceptBill = (ScfAcceptBillDO) RuleServiceDubboFilterInvoker.getInputObj();
        return AjaxObject
                .newOk("汇票信息修改成功", acceptBillService.saveModifyAcceptBill(anAcceptBill, anFileList, anConfirmFlag))
                .toJson();
    }
    ...
    public String webQueryIneffectiveAcceptBill(Map<String, Object> anAnMap, String anIsOnlyNormal, String anFlag,
        ...
        return AjaxObject.newOkWithPage("汇票信息查询成功", acceptBillService.queryIneffectiveBill(anQueryConditionMap,
    ...
    public String webQueryEffectiveAcceptBill(Map<String, Object> anAnMap, String anIsOnlyNormal, String anFlag,
        ...
        final Map<String, Object> anQueryConditionMap = (Map<String, Object>) RuleServiceDubboFilterInvoker
                .getInputObj();
        return AjaxObject.newOkWithPage("汇票信息查询成功", acceptBillService.queryEffectiveBill(anQueryConditionMap,
    ...
    public String webQueryCanAnnulAcceptBill(Map<String, Object> anAnMap, String anIsOnlyNormal, String anFlag,
        ...
        final Map<String, Object> anQueryConditionMap = (Map<String, Object>) RuleServiceDubboFilterInvoker
                .getInputObj();
        return AjaxObject.newOkWithPage("汇票信息查询成功",
                acceptBillService.queryCanAnnulBill(anQueryConditionMap, anIsOnlyNormal, anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webSaveModifyAcceptBillFile(String anFileList, String anRefNo, String anVersion) {
        ...
        return AjaxObject
                .newOk("汇票信息修改成功", acceptBillService.saveModifyAcceptBillDOFile(anFileList, anRefNo, anVersion))
                .toJson();
    }
