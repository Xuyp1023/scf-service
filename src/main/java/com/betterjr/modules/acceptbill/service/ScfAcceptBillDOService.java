...
public class ScfAcceptBillDOService extends BaseVersionService<ScfAcceptBillDOMapper, ScfAcceptBillDO> {
     ...
     * @return
     */
    public Page<ScfAcceptBillDO> queryIneffectiveBill(Map<String, Object> anMap, String anIsOnlyNormal, String anFlag,
            int anPageNum, int anPageSize, boolean anAuditFlag) {
     ...
     * @return
     */
    public Page<ScfAcceptBillDO> queryEffectiveBill(Map<String, Object> anMap, String anIsOnlyNormal, String anFlag,
    ...
    public Page<ScfAcceptBillDO> queryCanAnnulBill(Map<String, Object> anMap, String anIsOnlyNormal, String anFlag,
