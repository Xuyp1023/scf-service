...
@Service
public class ScfAssetDictAttachRelationService extends BaseService<ScfAssetDictAttachRelationMapper, ScfAssetDictAttachRelation> {
	...
	public List queryProductCoreRelation(Map<String, Object> anMap) {
		 BTAssert.notNull(anMap.get("productCode"), "查询失败");
