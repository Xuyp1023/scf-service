...
public enum RequestTradeStatusType {
    ...
    CLOSED("-100", "中止"), PENDING("100", "申请"), BLENDING("110", "出具保理方案"), REPORTING("120", "融资方确认方案"), REJECT_MODIFIY(
            "130", "发起贸易背景确认"), WASTE_SINGLE("140", "核心企业确认背景"), BE_REMOVED("150", "放款确认"), REPORTED("160", "放款完成");
