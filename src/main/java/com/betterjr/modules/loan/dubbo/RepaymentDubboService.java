...
public class RepaymentDubboService implements IScfRepaymentService {
    ...
    @Override
    public String webQueryDistributeFee(String anRequestNo, String anPayType, String anPayDate,
            BigDecimal anTotalBalance) {
        return AjaxObject
                .newOk("操作成功", payPlanService.queryDistributeFee(anRequestNo, anPayType, anPayDate, anTotalBalance))
                .toJson();
    }

    @Override
    public String webQuerySellerRepaymentFee(String anRequestNo, String anPayType, String anPayDate,
            BigDecimal anTotalBalance) {
        return AjaxObject
                .newOk("操作成功",
                        payPlanService.querySellerRepaymentFee(anRequestNo, anPayType, anPayDate, anTotalBalance))
                .toJson();
    }
    ...
    public String webQueryPayPlanList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("还款查询成功", payPlanService
                .queryPayPlanList((Map) RuleServiceDubboFilterInvoker.getInputObj(), anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webSaveModifyPayPlan(Map<String, Object> anMap, Long anId) {
        ...
        return AjaxObject
                .newOk(payPlanService.saveModifyPayPlan((ScfPayPlan) RuleServiceDubboFilterInvoker.getInputObj(), anId))
                .toJson();
    }
    ...
    public String webQueryPayRecordList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("查询成功", payRecordService
                .queryPayRecordList((Map) RuleServiceDubboFilterInvoker.getInputObj(), anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webSaveModifyPayRecord(Map<String, Object> anMap, Long anId) {
        ...
        return AjaxObject.newOk(
                payRecordService.saveModifyPayRecord((ScfPayRecord) RuleServiceDubboFilterInvoker.getInputObj(), anId))
                .toJson();
    }
    ...
    public String webQueryRecordDetailList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("查询成功", payRecordDetailService.queryRecordDetailList(
                (Map) RuleServiceDubboFilterInvoker.getInputObj(), anFlag, anPageNum, anPageSize)).toJson();
    }
    ...
    public String webSaveModifyRecordDetail(Map<String, Object> anMap, Long anId) {
        ...
        return AjaxObject
                .newOk(payRecordDetailService
                        .saveModifyRecordDetail((ScfPayRecordDetail) RuleServiceDubboFilterInvoker.getInputObj(), anId))
                .toJson();
    }
    ...
    public String webQueryExemptList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("分页查询豁免列表成功",
                exemptService.queryExemptList(qyConditionMap, anFlag, anPageNum, anPageSize)).toJson();
    }
    ...
    public String webQueryPressMoneyList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("分页查询催收列表成功",
                pressMoneyService.queryPressMoneyList(anMap, anFlag, anPageNum, anPageSize)).toJson();
    }
    ...
    @Override
    public String webCalculatExtensionFee(BigDecimal anRatio, BigDecimal anManagementRatio,
            BigDecimal anExtensionBalance) {
        logger.debug("计算展期费用，入参：" + anExtensionBalance);
        return AjaxObject.newOk("操作成功", extensionService.getInterest(anRatio, anManagementRatio, anExtensionBalance))
                .toJson();
    }
    ...
    @Override
    public String webQueryExtensionList(Map<String, Object> anMap, String requestNo, int anFlag, int anPageNum,
            int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("分页查询催收列表成功",
                extensionService.queryExtensionList(qyConditionMap, anFlag, anPageNum, anPageSize)).toJson();
    }
