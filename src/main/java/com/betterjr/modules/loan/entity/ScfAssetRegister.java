...
public class ScfAssetRegister implements BetterjrEntity {
    ...
    public boolean equals(Object obj) {
        ...
        if (registerCustName == null) {
            if (other.registerCustName != null) return false;
        } else if (!registerCustName.equals(other.registerCustName)) return false;
        if (registerCustNo == null) {
            if (other.registerCustNo != null) return false;
        } else if (!registerCustNo.equals(other.registerCustNo)) return false;
        if (registrant == null) {
            if (other.registrant != null) return false;
        } else if (!registrant.equals(other.registrant)) return false;
        if (requestNo == null) {
