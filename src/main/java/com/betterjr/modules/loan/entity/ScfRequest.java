...
public class ScfRequest implements BetterjrEntity {
    ...
    public boolean equals(Object obj) {
        ...
        if (actualDate == null) {
            if (other.actualDate != null) return false;
        } else if (!actualDate.equals(other.actualDate)) return false;
        if (aduit == null) {
            if (other.aduit != null) return false;
        } else if (!aduit.equals(other.aduit)) return false;
        if (approvedBalance == null) {
            if (other.approvedBalance != null) return false;
        } else if (!approvedBalance.equals(other.approvedBalance)) return false;
        if (approvedPeriod == null) {
            if (other.approvedPeriod != null) return false;
        } else if (!approvedPeriod.equals(other.approvedPeriod)) return false;
        if (approvedPeriodUnit == null) {
            if (other.approvedPeriodUnit != null) return false;
        } else if (!approvedPeriodUnit.equals(other.approvedPeriodUnit)) return false;
        if (approvedRatio == null) {
            if (other.approvedRatio != null) return false;
        } else if (!approvedRatio.equals(other.approvedRatio)) return false;
        if (balance == null) {
        ...
        } else if (!billNo.equals(other.billNo)) return false;
        if (bondBalance == null) {
            if (other.bondBalance != null) return false;
        } else if (!bondBalance.equals(other.bondBalance)) return false;
        if (buyerNo == null) {
            if (other.buyerNo != null) return false;
        } else if (!buyerNo.equals(other.buyerNo)) return false;
        if (cashRequestNo == null) {
            if (other.cashRequestNo != null) return false;
        } else if (!cashRequestNo.equals(other.cashRequestNo)) return false;
        if (checker == null) {
            if (other.checker != null) return false;
        } else if (!checker.equals(other.checker)) return false;
        if (checkerNo == null) {
            if (other.checkerNo != null) return false;
        } else if (!checkerNo.equals(other.checkerNo)) return false;
        if (cleanDate == null) {
            if (other.cleanDate != null) return false;
        } else if (!cleanDate.equals(other.cleanDate)) return false;
        if (confirmBalance == null) {
            if (other.confirmBalance != null) return false;
        } else if (!confirmBalance.equals(other.confirmBalance)) return false;
        if (confirmCause == null) {
            if (other.confirmCause != null) return false;
        } else if (!confirmCause.equals(other.confirmCause)) return false;
        if (contactName == null) {
        ...
        } else if (!coreCustName.equals(other.coreCustName)) return false;
        if (coreCustNo == null) {
            if (other.coreCustNo != null) return false;
        } else if (!coreCustNo.equals(other.coreCustNo)) return false;
        if (creditMode == null) {
            if (other.creditMode != null) return false;
        } else if (!creditMode.equals(other.creditMode)) return false;
        if (creditMoney == null) {
            if (other.creditMoney != null) return false;
        } else if (!creditMoney.equals(other.creditMoney)) return false;
        if (custName == null) {
            if (other.custName != null) return false;
        } else if (!custName.equals(other.custName)) return false;
        if (custNo == null) {
            if (other.custNo != null) return false;
        } else if (!custNo.equals(other.custNo)) return false;
        if (custType == null) {
            if (other.custType != null) return false;
        } else if (!custType.equals(other.custType)) return false;
        if (description == null) {
        ...
        if (extensionRatio == null) {
            if (other.extensionRatio != null) return false;
        } else if (!extensionRatio.equals(other.extensionRatio)) return false;
        if (factorName == null) {
            if (other.factorName != null) return false;
        } else if (!factorName.equals(other.factorName)) return false;
        if (factorNo == null) {
            if (other.factorNo != null) return false;
        } else if (!factorNo.equals(other.factorNo)) return false;
        if (factorRequestNo == null) {
            if (other.factorRequestNo != null) return false;
        } else if (!factorRequestNo.equals(other.factorRequestNo)) return false;
        if (flowStatus == null) {
            if (other.flowStatus != null) return false;
        } else if (!flowStatus.equals(other.flowStatus)) return false;
        if (invoiceBalance == null) {
            if (other.invoiceBalance != null) return false;
        } else if (!invoiceBalance.equals(other.invoiceBalance)) return false;
        if (lastStatus == null) {
            if (other.lastStatus != null) return false;
        } else if (!lastStatus.equals(other.lastStatus)) return false;
        if (loanBalance == null) {
            if (other.loanBalance != null) return false;
        } else if (!loanBalance.equals(other.loanBalance)) return false;
        if (loanNo == null) {
            if (other.loanNo != null) return false;
        } else if (!loanNo.equals(other.loanNo)) return false;
        if (managementRatio == null) {
            if (other.managementRatio != null) return false;
        } else if (!managementRatio.equals(other.managementRatio)) return false;
        if (modiDate == null) {
        ...
        if (operCode == null) {
            if (other.operCode != null) return false;
        } else if (!operCode.equals(other.operCode)) return false;
        if (operDate == null) {
            if (other.operDate != null) return false;
        } else if (!operDate.equals(other.operDate)) return false;
        if (operOrg == null) {
            if (other.operOrg != null) return false;
        } else if (!operOrg.equals(other.operOrg)) return false;
        if (operTime == null) {
            if (other.operTime != null) return false;
        } else if (!operTime.equals(other.operTime)) return false;
        if (orderBalance == null) {
            if (other.orderBalance != null) return false;
        } else if (!orderBalance.equals(other.orderBalance)) return false;
        if (orders == null) {
            if (other.orders != null) return false;
        } else if (!orders.equals(other.orders)) return false;
        if (outStatus == null) {
            if (other.outStatus != null) return false;
        } else if (!outStatus.equals(other.outStatus)) return false;
        if (overdueRatio == null) {
            if (other.overdueRatio != null) return false;
        } else if (!overdueRatio.equals(other.overdueRatio)) return false;
        if (payPlan == null) {
            if (other.payPlan != null) return false;
        } else if (!payPlan.equals(other.payPlan)) return false;
        if (period == null) {
            if (other.period != null) return false;
        } else if (!period.equals(other.period)) return false;
        if (periodUnit == null) {
            if (other.periodUnit != null) return false;
        } else if (!periodUnit.equals(other.periodUnit)) return false;
        if (productCode == null) {
        ...
        } else if (!ratio.equals(other.ratio)) return false;
        if (regDate == null) {
        ...
        if (remainMoney == null) {
            if (other.remainMoney != null) return false;
        } else if (!remainMoney.equals(other.remainMoney)) return false;
        if (requestDate == null) {
            if (other.requestDate != null) return false;
        } else if (!requestDate.equals(other.requestDate)) return false;
        if (requestFrom == null) {
            if (other.requestFrom != null) return false;
        } else if (!requestFrom.equals(other.requestFrom)) return false;
        if (requestNo == null) {
        ...
        if (servicefeeBalance == null) {
            if (other.servicefeeBalance != null) return false;
        } else if (!servicefeeBalance.equals(other.servicefeeBalance)) return false;
        if (servicefeeRatio == null) {
            if (other.servicefeeRatio != null) return false;
        } else if (!servicefeeRatio.equals(other.servicefeeRatio)) return false;
        if (suppBankAccount == null) {
            if (other.suppBankAccount != null) return false;
        } else if (!suppBankAccount.equals(other.suppBankAccount)) return false;
        if (supplierNo == null) {
            if (other.supplierNo != null) return false;
        } else if (!supplierNo.equals(other.supplierNo)) return false;
        if (tradeStatus == null) {
            if (other.tradeStatus != null) return false;
        } else if (!tradeStatus.equals(other.tradeStatus)) return false;
        if (version == null) {
