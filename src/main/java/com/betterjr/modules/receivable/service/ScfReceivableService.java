...
public class ScfReceivableService extends BaseService<ScfReceivableMapper, ScfReceivable>{
     ...
     * 应收账款编辑
     */
    public ScfReceivable saveModifyReceivable(ScfReceivable anMoidReceivable, Long anId) {
        ...
        //检查用户是否有权限编辑
        checkOperator(anReceivable.getOperOrg(), "当前操作员不能修改该融资产品");
        ...
        //应收账款信息变更迁移初始化
        anMoidReceivable.initModifyValue(anReceivable);
        //数据存盘
        this.updateByPrimaryKey(anMoidReceivable);
