...
public class EnquiryDubboService implements IScfEnquiryService {
    ...
    public String webQueryEnquiryList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("查询成功", enquiryService.queryEnquiryList(anMap, anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webQuerySingleOrderEnquiryList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        logger.debug("分页查询询价列表,入参：" + anMap);
        return AjaxObject
                .newOkWithPage("查询成功", enquiryService.querySingleOrderEnquiryList(anMap, anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webAddEnquiry(Map<String, Object> anMap) {
        ...
        return AjaxObject.newOk(enquiryService.addEnquiry((ScfEnquiry) RuleServiceDubboFilterInvoker.getInputObj()))
                .toJson();
    }
    ...
    public String webQueryOfferList(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject.newOkWithPage("查询成功", offerService.queryOfferList(anMap, anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webSaveModifyOffer(Map<String, Object> anMap, Long anId) {
        ...
        return AjaxObject
                .newOk(offerService.saveModifyOffer((ScfOffer) RuleServiceDubboFilterInvoker.getInputObj(), anId))
                .toJson();
    }
    ...
    public String webQueryEnquiryByfactorNo(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        return AjaxObject
                .newOkWithPage("查询成功", enquiryService.queryEnquiryByfactorNo(anMap, anFlag, anPageNum, anPageSize))
                .toJson();
    }
    ...
    public String webAddOfferReply(Map<String, Object> anMap) {
        ...
        return AjaxObject
                .newOk(offerReplyService.add((ScfEnquiryOfferReply) RuleServiceDubboFilterInvoker.getInputObj()))
                .toJson();
    }
    ...
    public String webSaveModifyOfferReply(Map<String, Object> anMap, Long anId) {
        ...
        return AjaxObject.newOk(
                offerReplyService.saveModify((ScfEnquiryOfferReply) RuleServiceDubboFilterInvoker.getInputObj(), anId))
                .toJson();
    }
    ...
    public String webQueryOfferReply(Map<String, Object> anMap, int anFlag, int anPageNum, int anPageSize) {
        ...
        anMap = (Map) RuleServiceDubboFilterInvoker.getInputObj();
        return AjaxObject.newOkWithPage("查询成功", offerReplyService.queryList(anMap, anFlag, anPageNum, anPageSize))
                .toJson();
    }
