...
public class ScfEnquiry implements BetterjrEntity {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getFactors() == null ? other.getFactors() == null
                        : this.getFactors().equals(other.getFactors()))
                ...
                && (this.getStrategy() == null ? other.getStrategy() == null
                        : this.getStrategy().equals(other.getStrategy()))
                && (this.getBusinStatus() == null ? other.getBusinStatus() == null
                        : this.getBusinStatus().equals(other.getBusinStatus()))
                && (this.getOfferCount() == null ? other.getOfferCount() == null
                        : this.getOfferCount().equals(other.getOfferCount()))
                && (this.getEnquiryMethod() == null ? other.getEnquiryMethod() == null
                        : this.getEnquiryMethod().equals(other.getEnquiryMethod()))
                && (this.getDropReason() == null ? other.getDropReason() == null
                        : this.getDropReason().equals(other.getDropReason()));
    }
    ...
    public void init() {
        ...
        this.offerCount = 0;
        this.businStatus = "0";
        if (StringUtils.isBlank(this.actualDate)) {
