...
public class ScfOffer implements BetterjrEntity {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getMinCycle() == null ? other.getMinCycle() == null
                        : this.getMinCycle().equals(other.getMinCycle()))
                && (this.getMaxCycle() == null ? other.getMaxCycle() == null
                        : this.getMaxCycle().equals(other.getMaxCycle()))
                ...
                && (this.getQuoteType() == null ? other.getQuoteType() == null
                        : this.getQuoteType().equals(other.getQuoteType()))
