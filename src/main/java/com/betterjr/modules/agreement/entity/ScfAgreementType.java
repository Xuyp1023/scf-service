...
public class ScfAgreementType implements BetterjrEntity {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getAgreementTypeNo() == null ? other.getAgreementTypeNo() == null
                        : this.getAgreementTypeNo().equals(other.getAgreementTypeNo()))
                && (this.getAgreementTypeName() == null ? other.getAgreementTypeName() == null
                        : this.getAgreementTypeName().equals(other.getAgreementTypeName()))
