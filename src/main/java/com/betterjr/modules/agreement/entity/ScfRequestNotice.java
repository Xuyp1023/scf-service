...
public class ScfRequestNotice implements BetterjrEntity, BaseRemoteEntity {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getRequestNo() == null ? other.getRequestNo() == null
                ...
                && (this.getFactorAddr() == null ? other.getFactorAddr() == null
                        : this.getFactorAddr().equals(other.getFactorAddr()))
                && (this.getFactorPost() == null ? other.getFactorPost() == null
                        : this.getFactorPost().equals(other.getFactorPost()))
                && (this.getFactorLinkMan() == null ? other.getFactorLinkMan() == null
                        : this.getFactorLinkMan().equals(other.getFactorLinkMan()))
                && (this.getModiDate() == null ? other.getModiDate() == null
                        : this.getModiDate().equals(other.getModiDate()))
                && (this.getNoticeTime() == null ? other.getNoticeTime() == null
                        : this.getNoticeTime().equals(other.getNoticeTime()))
