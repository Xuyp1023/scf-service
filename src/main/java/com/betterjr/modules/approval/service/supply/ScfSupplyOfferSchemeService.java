...
@Service
public class ScfSupplyOfferSchemeService extends ScfBaseApprovalService {
    @Autowired
    ...
    public void processPass(ScfRequestScheme scheme) {
        ...
        this.updateRequestStatus(scheme.getRequestNo(), RequestTradeStatus.CONFIRM_SCHEME.getCode(),
