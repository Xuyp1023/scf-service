...
public class ScfAssetBasedata implements BetterjrEntity {
    ...
    public String toString() {
        return "ScfAssetBasedata [Hash = " + hashCode() + ", id=" + this.id + ", regDate=" + this.regDate + ", regTime="
                + this.regTime + ", assetId=" + this.assetId + ", version=" + this.version + ", refNo=" + this.refNo
                + ", businStatus=" + this.businStatus + ", infoType=" + this.infoType + ", serialVersionUID="
                + serialVersionUID + "]";
    }
