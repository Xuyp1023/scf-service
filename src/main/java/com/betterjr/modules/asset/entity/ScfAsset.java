...
public class ScfAsset implements BetterjrEntity {
    ...
    public String toString() {
        return "ScfAsset [id=" + this.id + ", regDate=" + this.regDate + ", endDate=" + this.endDate + ", regTime="
                + this.regTime + ", businStatus=" + this.businStatus + ", businTypeId=" + this.businTypeId
                + ", productCode=" + this.productCode + ", sourceUseType=" + this.sourceUseType + ", custNo="
                + this.custNo + ", custName=" + this.custName + ", coreCustNo=" + this.coreCustNo + ", coreCustName="
                + this.coreCustName + ", prefixId=" + this.prefixId + ", suffixId=" + this.suffixId + ", custType="
                + this.custType + ", custMap=" + this.custMap + ", basedataMap=" + this.basedataMap + ", orderList="
                + this.orderList + ", invoiceList=" + this.invoiceList + ", agreementList=" + this.agreementList
                + ", receivableList=" + this.receivableList + ", acceptBillList=" + this.acceptBillList
                + ", operationAuth=" + this.operationAuth + ", factorNo=" + this.factorNo + ", regOperId="
                + this.regOperId + ", regOperName=" + this.regOperName + ", annulOperId=" + this.annulOperId
                + ", annulOperName=" + this.annulOperName + ", annulDate=" + this.annulDate + ", annulTime="
                + this.annulTime + ", statementBatchNo=" + this.statementBatchNo + ", goodsBatchNo=" + this.goodsBatchNo
                + ", othersBatchNo=" + this.othersBatchNo + ", custBankName=" + this.custBankName + ", custBankAccount="
                + this.custBankAccount + ", custBankAccountName=" + this.custBankAccountName + ", coreCustBankName="
                + this.coreCustBankName + ", coreCustBankAccount=" + this.coreCustBankAccount
                + ", coreCustBankAccountName=" + this.coreCustBankAccountName + ", balance=" + this.balance + "]";
    }
