...
public class ExcelColumnCell implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (cloumnChineseName == null) {
            if (other.cloumnChineseName != null) return false;
        } else if (!cloumnChineseName.equals(other.cloumnChineseName)) return false;
        if (cloumnOrder == null) {
            if (other.cloumnOrder != null) return false;
        } else if (!cloumnOrder.equals(other.cloumnOrder)) return false;
        if (cloumnProperties == null) {
            if (other.cloumnProperties != null) return false;
        } else if (!cloumnProperties.equals(other.cloumnProperties)) return false;
        if (cloumnType == null) {
            if (other.cloumnType != null) return false;
        } else if (!cloumnType.equals(other.cloumnType)) return false;
        if (isMust == null) {
            if (other.isMust != null) return false;
        } else if (!isMust.equals(other.isMust)) return false;
        if (vailedRegular == null) {
            if (other.vailedRegular != null) return false;
        } else if (!vailedRegular.equals(other.vailedRegular)) return false;
        return true;
    }
