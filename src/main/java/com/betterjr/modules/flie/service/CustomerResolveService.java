...
public class CustomerResolveService {
     ...
     * @param anIs excel文件输入流
     * @param anFileCloumnList;
     * @param anFileType;  文件的类型
     * @param beginRow;  从哪行开始解析
     * @return
     * @throws IOException 
     */
    private List<Map<String, Object>> convertListMap(InputStream anIs, List<CustFileCloumn> anFileCloumnList,Map<String,Object> appendMap,String anFileType,int beginRow) throws IOException {
