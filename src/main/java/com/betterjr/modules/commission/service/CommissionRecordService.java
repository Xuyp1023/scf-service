...
public class CommissionRecordService extends BaseService<CommissionRecordMapper, CommissionRecord> {
     ...
     * @return
     */
    public Page queryRecordList(final Map<String, Object> anMap, final String anFlag, final int anPageNum, final int anPageSize) {
    ...
    public CommissionRecordAuditResult saveAuditRecordList(final Map<String, Object> anMap){
