...
public class CommissionParamService extends BaseService<CommissionParamMapper, CommissionParam> {
    ...
    public CommissionParam saveUpdateParam(CommissionParam anParam){
        ...
        checkStatus(param.getBusinStatus(), CommissionConstantCollentions.COMMISSION_INVOICE_PARAM_CUST_BUSINSTATUS_FAILER, true, "当前参数已经失效，无法修改");
     ...
     * @return
     */
    public Page<CommissionParam> queryParamList(Map<String, Object> anMap, String anFlag, int anPageNum, int anPageSize){
        ...
        Page<CommissionParam> page = this.selectPropertyByPage(anMap, anPageNum, anPageSize, "1".equals(anFlag), "id desc");
