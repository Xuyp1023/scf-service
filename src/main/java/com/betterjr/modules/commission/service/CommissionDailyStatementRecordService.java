 ...
 */
@Service
public class CommissionDailyStatementRecordService
        extends BaseService<CommissionDailyStatementRecordMapper, CommissionDailyStatementRecord> {

    /***
     * 条件分页查询
     * @return
     */
    public Page<CommissionDailyStatementRecord> queryCommissionDailyStatementRecord(Map<String, Object> anMap,
     ...
     * @return
     */
    public Page<CommissionDailyStatementRecord> queryCommissionDailyStatementRecordByRefNo(Long anDailyStatementId,
            int anPageNum, int anPageSize, String anFlag) {
